import { getContractAddress, getBadgesAddress, getTournamentAddress } from "./constants";
import ACHIEVEMENTS_ABI from "./achievements-abi.json";
import TOURNAMENT_ABI from "./tournament-abi.json";
