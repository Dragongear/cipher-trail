/**
 * Deploy CipherTrail contract to Base Sepolia using solc + viem
 * Usage: PRIVATE_KEY=0x... npx tsx scripts/deploy.js
 */
...
if (!privateKey) {
  console.error("Usage: PRIVATE_KEY=0x... npx tsx scripts/deploy.js");
  process.exit(1);
}
...
const contract = output.contracts["CipherTrail.sol"]["CipherTrail"];
...
async function main() {
  ...
  console.log("Deploying CipherTrail contract...");
